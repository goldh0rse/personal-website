  ...
  return (
    <ThemeProvider attribute='class'>
      ...
      <div className='grid grid-cols-12 gap-6 lg:px-48 my-14 sm:px-20 md:px-32'>
        ...
        <div className='flex flex-col col-span-12 overflow-hidden bg-white dark:bg-dark-700 lg:col-span-9 rounded-2xl shadow-custom-light dark:shadow-custom-dark'>
          <Navbar/>
          <Component {...pageProps} />  
        </div>
      </div> 
